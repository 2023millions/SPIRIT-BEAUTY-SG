...
export default function Home(){
  ...
  return <main id="top" className="overflow-x-hidden pb-20 md:pb-0">
    ...
    <section className="relative min-h-[760px] bg-[#17130d] text-white">
      <img src="/media/IMG-20260827-WA0001.jpg" alt="Spirit Beauty storefront in Ang Mo Kio" className="absolute inset-0 h-full w-full object-cover object-[center_0.2%]"/>
