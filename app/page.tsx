...
export default function Home(){
  ...
  return <main id="top" className="overflow-x-hidden pb-20 md:pb-0">
    ...
    <section className="relative min-h-[760px] bg-[#17130d] text-white">
      <img src="/media/IMG-20260827-WA0001.jpg" alt="Spirit Beauty storefront in Ang Mo Kio" className="absolute inset-0 h-full w-full object-contain object-top sm:object-cover sm:object-[center_0.2%]"/>
    ...
    <section id="ipl" className="scroll-mt-20 bg-cream py-20 lg:py-28"><div className="container-page">
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_.9fr] lg:items-start"><div><h3 className="font-display text-3xl font-semibold">Why clients choose our SHR IPL</h3><div className="mt-6 grid gap-3 sm:grid-cols-2">{["Shaving and treatment gel included","Unlimited shots for the treatment area","Fast, targeted treatment","Helps reduce the appearance of ingrown hairs","No hard selling","No hidden costs"].map(item=><div key={item} className="rounded-xl bg-white p-4 text-sm font-semibold shadow-sm">✓ {item}</div>)}</div><p className="mt-5 text-xs leading-5 text-ink/45">Hair-reduction results and treatment experience vary between individuals.</p><div className="mt-7"><CTA href={brazilianHref}>Book Brazilian $48</CTA></div></div><figure className="overflow-hidden rounded-3xl border border-sand bg-white shadow-soft"><img src="/media/ipl-result-1.jpg" alt="Brazilian IPL before and after result" className="w-full object-cover"/><img src="/media/ipl-result-2.jpg" alt="Brazilian IPL result" className="w-full object-cover"/><figcaption className="px-5 py-4 text-xs font-semibold uppercase tracking-widest text-cocoa">Real client result · Brazilian IPL</figcaption></figure></div>
    </div></section>
